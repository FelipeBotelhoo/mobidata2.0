    ...
    <>
      ...
      <div className="form-container-wrapper">
        ...
        <Form onSubmit={handleSubmit} className="form-fields-side">
            <Form.Group className="mb-3 form-group" controlId="nome">
          ...
          <div className="form-row">
            <Form.Group className="mb-3 form-group" controlId="cpf">
          ...
          <div className="form-row">
            <Form.Group className="mb-3 form-group" controlId="rua">
          ...
          <div className="form-row">
            ...
            <Form.Group className="mb-3 form-group" controlId="uf">
          ...
          <Form.Group className="mb-3" controlId="id" style={{display: 'none'}}>
            <Form.Control
              type="text"
              name="id"
          ...
          {/* Situação (se aplicável) */}
          {userClicked && userClicked.id >= 1 && (
            <Form.Group className="mb-3 form-group full-width" controlId="situacao">
